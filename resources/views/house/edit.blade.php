                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('houses.update', $house->id) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $house->name)  }}" autocomplete="name" autofocus>
                                    @error('name')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price', $house->price) }}" autocomplete="price" autofocus>
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control @error('location_id') is-invalid @enderror" name="location_id" value="{{ old('location_id') }}" required autofocus>
                                        ...
                                        @foreach($locations as $location)
                                            <option value="{{$location->id}}" {{$house->location_id == $location->id ? 'selected' : ''}}>{{$location->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('location_id')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control @error('landlord_id') is-invalid @enderror" name="landlord_id" required autofocus>
...
{{--                            </div>--}}
                            <div class="form-group">
                                ...
                                @foreach ($utilities as $utility)
                                    <label>
                                        <input type="checkbox" name="utilities[]" value="{{ $utility->id }}" {{ $house->utilities->contains($utility->id) ? 'checked' : '' }}>
                                        {{ $utility->name }}
                                    </label>
                                    <br>
                                @endforeach
